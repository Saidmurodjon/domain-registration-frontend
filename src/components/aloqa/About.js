...
const About = () => {
  return (
    <div className="px-4">
      <h1 className="font-semibold text-[#1F3D9D] text-[30px]">Aloqa Uchun</h1>
      ...
      <h2 className="text-[16px] dark:text-[#5B5B5B] mt-10">
        Farg`ona viloyat hokimligi binosi Axmad Al Farg'oniy va Alisher Navoiy
        ko`chalari kesishgan joyda, "Aziya" mehmonhonasi yonida ostanovka 'A'
        joylashgan. Bu yerga "Markaz-Aeroport" yo`nalishida qatnovchi barcha
        shahar transportlarida borish mumkin.
      </h2>
    </div>
  );
};
