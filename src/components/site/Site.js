...
const Sayt = () => {
  ...
  return (
    <div className={`bg-map pb-[80px] lg:pb-[160px] pt-[50px] lg:pt-[90px]`}>
      {/* up */}
      <div className="">
        <div className="px-2 md:px-0 md:py-5">
          <h1 className=" text-[#1F3D9D] text-[24px] lg:text-[48px] text-center title-font">
            {Data.site.title}
          </h1>
          <hr className="border-[#00A59C] border-t-2 w-[90px] mx-auto" />
          <h2 className="md:w-[637px] xl:w-[773px] text-base md:text-center mx-auto text-[#797979] my-6">
            {Data.site.about}
          </h2>
        </div>
