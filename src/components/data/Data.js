const uz = {
  ...
  domain: {
    ...
    information: {
      ...
      about1:
        "davlat unitar korxonasi UZ domen nomlarini rasmiy ro’yxatga oluvchi (registrator) hisoblanadi",
      title2:
        "Internet tarmoqlar milliy segmenti domen nomlaridan foydalanish tartibi to'g'risida",
      about2: "nizomi muvofiqligida xizmat ko'rsatish amalga oshiriladi.",
    },
  },
  hosting: {
    title: "ISHONCHLI HOSTING XIZMATI",
    ...
    card: {
      hajmi: "Hajmi",
      domain: "Domenlar",
      subdomain: "Supdomenlar",
      db: "DB Mysql",
      domainuz: "Domen.uz 1 yilga",
      pochta: "Pochta",
      trafik: "Trafik",
      backup: "Beckup olish",
      ftp: "FTP ulanish",
